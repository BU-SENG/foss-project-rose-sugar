      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="grid w-full max-w-6xl grid-cols-1 overflow-hidden rounded-xl border border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-900/50 shadow-sm md:grid-cols-2">
            {/* Left Side - Marketing */}
            <div className="hidden flex-col justify-center gap-8 bg-slate-100 p-8 text-center dark:bg-slate-900 md:flex">
              ...
              <div className="relative mx-auto h-64 w-64">
                <div className="absolute inset-0 flex items-center justify-center rounded-full bg-primary/10">
                  <div className="h-56 w-56 rounded-full bg-primary/20"></div>
                </div>
                <img
              ...
              <div className="w-full max-w-md">
                ...
                <form onSubmit={handleRegister} className="flex flex-col gap-4">
                  ...
                  <label className="flex flex-col w-full">
                    ...
                    <input
                      type="text"
                      className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-800 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-transparent h-12 placeholder:text-slate-400 dark:placeholder:text-slate-500 p-3 text-base font-normal leading-normal"
